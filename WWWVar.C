...
float WWW::mHrecoWconst() {
//   if (std_vector_neutrinoGen_eta.size()) cout << "neutrino eta " << std_vector_neutrinoGen_eta[0] << endl;
//     std_vector_leptonGen_MotherPID
//     std_vector_jetGen_eta
//     std_vector_partonGen_isPrompt
  return -9999.0;
}

float WWW::mZHrecoHconst() {
  return -9999.0;
}
